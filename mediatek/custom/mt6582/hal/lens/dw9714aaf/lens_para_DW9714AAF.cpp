...
const NVRAM_LENS_PARA_STRUCT DW9714AAF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
...
UINT32 DW9714AAF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &DW9714AAF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pDW9714AAF_getDefaultData = DW9714AAF_getDefaultData;
