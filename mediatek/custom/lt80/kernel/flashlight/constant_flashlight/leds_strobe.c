...
Functions
*****************************************************************************/
#define GPIO_CTRL GPIO_FLASH_EN
#define GPIO_TX GPIO_FLASH_SEL
#define GPIO_STROBE GPIO_FLASH_STROBE
...
int FL_Init(void)
{
    ...
    if(mt_set_gpio_out(GPIO_CTRL,GPIO_OUT_ONE)){PK_DBG("[constant_flashlight] set gpio failed!! \n");}
    /*Init. to disable*/
