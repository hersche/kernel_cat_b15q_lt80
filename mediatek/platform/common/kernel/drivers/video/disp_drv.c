...
// sysfs
DISP_STATUS DISP_RegisterSysfs(struct device *dev)
{
	  lcm_drv->sysfs_register(dev);
    return DISP_STATUS_OK;
}

DISP_STATUS DISP_UnregisterSysfs(struct device *dev)
{
	  lcm_drv->sysfs_unregister(dev);
    return DISP_STATUS_OK;
}
